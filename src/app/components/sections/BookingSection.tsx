...
export function BookingSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const msg = `Hi! Mujhe ${salon.name} mein appointment chahiye.
...
className = "bg-[#E91E8C] text-white rounded-full px-8 py-3 font-body font-medium hover:bg-[#C2157A] transition-all"
  ...
  < div className = "grid grid-cols-1 md:grid-cols-2 gap-6 mb-7" >
    ...
    < div className = "relative border-b border-[#F5C6E0] pb-1 focus-within:border-[#E91E8C] transition-colors duration-200" >
      <label
                      className={
  `absolute left-0 font-body text-[#9B7A8A] pointer-events-none transition-all duration-200 ${formData.name
...
<div className="relative border-b border-[#F5C6E0] pb-1 focus-within:border-[#E91E8C] transition-colors duration-200" >
  <label
                      className={
  `absolute left-0 font-body text-[#9B7A8A] pointer-events-none transition-all duration-200 ${formData.phone
    ? "-top-3 text-[0.7rem] text-[#E91E8C]"
    : "top-3 text-[0.87rem]"
  }`
}
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-7" >
  ...
  < div className = "relative border-b border-[#F5C6E0] pb-1 focus-within:border-[#E91E8C] transition-colors duration-200" >
    <label
                      className={
  `absolute left-0 font-body text-[#9B7A8A] pointer-events-none transition-all duration-200 ${formData.date
    ? "-top-3 text-[0.7rem] text-[#E91E8C]"
    : "top-3 text-[0.87rem]"
  }`
}
...
<div className="relative border-b border-[#F5C6E0] pb-1 focus-within:border-[#E91E8C] transition-colors duration-200" >
  <label
                      className={
  `absolute left-0 font-body text-[#9B7A8A] pointer-events-none transition-all duration-200 ${formData.time
    ? "-top-3 text-[0.7rem] text-[#E91E8C]"
    : "top-3 text-[0.87rem]"
  }`
}
...
<div className="mb-7 relative border-b border-[#F5C6E0] pb-1 focus-within:border-[#E91E8C] transition-colors duration-200" >
  <label
                    className={
  `absolute left-0 font-body text-[#9B7A8A] pointer-events-none transition-all duration-200 ${formData.service
    ? "-top-3 text-[0.7rem] text-[#E91E8C]"
    : "top-3 text-[0.87rem]"
  }`
}
...
<div className="mb-7 relative border-b border-[#F5C6E0] pb-1 focus-within:border-[#E91E8C] transition-colors duration-200" >
  <label
                    className={
  `absolute left-0 font-body text-[#9B7A8A] pointer-events-none transition-all duration-200 ${formData.notes
    ? "-top-3 text-[0.7rem] text-[#E91E8C]"
    : "top-3 text-[0.87rem]"
  }`
}
